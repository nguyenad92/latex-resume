...
\definecolor{headings}{HTML}{2CCBC9} % Dark red colour for headings
\definecolor{shade}{HTML}{FFFFFF} % Peach colour for the contact information box
\definecolor{linkcolor}{HTML}{1887F7} % 25% desaturated headings colour for links
...
\newcommand{\projectposition}[5]{
	\begin{supertabular}{p{\linewidth}p{0.05\linewidth}}
		{\raggedleft\textsc{#1\expandafter\ifstrequal\expandafter{#2}{}{}{\hspace{6pt}\footnotesize{(#2)}}}\par} % Duration and conditional full time/part time text
	\end{supertabular}
